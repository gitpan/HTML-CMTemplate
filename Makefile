# This Makefile is for the HTML::CMTemplate extension to perl.
#
...
#	NAME => q[HTML::CMTemplate]
#	VERSION_FROM => q[CMTemplate.pm]
...
AR_STATIC_ARGS = cr
NAME = HTML::CMTemplate
DISTNAME = HTML-CMTemplate
NAME_SYM = HTML_CMTemplate
VERSION = 0.2
VERSION_SYM = 0_2
XS_VERSION = 0.2
INST_BIN = blib/bin
...
FULLEXT = HTML/CMTemplate
BASEEXT = CMTemplate
PARENT_NAME = HTML
DLBASE = $(BASEEXT)
VERSION_FROM = CMTemplate.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
TO_INST_PM = CMTemplate.pm

PM_TO_BLIB = CMTemplate.pm \
	$(INST_LIBDIR)/CMTemplate.pm
...
manifypods : pure_all CMTemplate.pm
	@$(POD2MAN) \
	CMTemplate.pm \
	$(INST_MAN3DIR)/HTML::CMTemplate.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -f $(INST_LIBDIR)/CMTemplate.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"HTML-CMTemplate\" VERSION=\"0,2,0,0\">\n}. qq{\t<TITLE>HTML-CMTemplate</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > HTML-CMTemplate.ppd
